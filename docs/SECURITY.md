...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on iagentic.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in our [issue tracker](/iagentic/iagentic/issues) or contact us on [Discord](https://discord.gg/5rJgQTnV4s).
